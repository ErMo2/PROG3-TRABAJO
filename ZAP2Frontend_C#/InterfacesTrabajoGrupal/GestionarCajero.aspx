<%@ Page Title="" Language="C#" MasterPageFile="~/ZAP3WA.Master" AutoEventWireup="true" CodeBehind="GestionarCajero.aspx.cs" Inherits="InterfacesTrabajoGrupal.Cajero" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphContenido" runat="server">
    ...
    <div class="card-body">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-8">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" id="rbMasculino" runat="server" value="M" name="Genero">
                    <label class="form-check-label" for="rbMasculino" runat="server">Masculino</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" id="rbFemenino" runat="server" value="F" name="Genero">
