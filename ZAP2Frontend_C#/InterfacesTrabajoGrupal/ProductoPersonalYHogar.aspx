<%@ Page Title="" Language="C#" MasterPageFile="~/SoftProg.Master" AutoEventWireup="true" CodeBehind="ProductoPersonalYHogar.aspx.cs" Inherits="InterfacesTrabajoGrupal.ProductoPersonalYHogar" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphContenido" runat="server">
    ...
    <div class="card">
        <h2>
            Registrar Producto Para el cuidado Personal y del Hogar:
        </h2>
    </div>
    <br />
    <div class="card-body">
