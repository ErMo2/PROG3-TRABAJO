        ...
        <div class="card shadow-lg">
            ...
            <div class="card-body">
                ...
                <div class="container mt-5 p-2">
                    <asp:TextBox ID="txtCorreo" runat="server" CssClass="form-control" Enabled="true" />
                    <asp:Button ID="btnShowPopup" runat="server" CssClass="btn btn-primary" Text="Avisar stock bajo " OnClick="btnOption_Click" />
                </div>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <div class="btn-group" role="group">
                                    <asp:LinkButton ID="lbModificarLote" runat="server" CommandName="ModificarLote" CommandArgument='<%# Eval("idLote") %>' Text="Ver" CssClass="btn btn-primary btn-sm" />
