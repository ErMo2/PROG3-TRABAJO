    ...
    <asp:GridView ID="gvClientes" runat="server" AutoGenerateColumns="False" CssClass="table table-hover table-responsive"
        ...
        <Columns>
            ...
            <asp:TemplateField>
                ...
                <ItemTemplate>
                    <asp:Button ID="btnModificar" runat="server" Text="Modificar" CommandArgument='<%# Eval("id_cliente") %>' CssClass="btn btn-primary btn-sm" OnClick="btnModificar_Click" />
                    <asp:Button ID="btnEliminar" runat="server" Text="Eliminar" CommandArgument='<%# Eval("id_cliente") %>' CssClass="btn btn-danger btn-sm" OnClick="btnEliminar_Click" />
                    <asp:Button ID="btnVer" runat="server" Text="Ver" CommandArgument='<%# Eval("id_cliente") %>' CssClass="btn btn-info btn-sm" OnClick="btnVer_Click" data-toggle="modal" data-target="#verClienteModal" />
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </asp:GridView>
