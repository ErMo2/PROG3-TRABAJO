...
<body>
        ...
        <div class="container">
            ...
            <div class="card-body">
                ...
                <div class="mb-3 row">
                    <asp:Label ID="lblMovimientoLote" runat="server" Text="Movimiento de Lote:" CssClass="col-sm-2 col-form-label" />
                    <div class="col-sm-8">
                        <asp:DropDownList ID="ddlMovimientoLote" runat="server" CssClass="form-control"></asp:DropDownList>
                    </div>
                </div>
                <div class="mb-3 row">
                    <asp:Label ID="lblLote" runat="server" Text="Lote:" CssClass="col-sm-2 col-form-label" />
                    <div class="col-sm-8">
                        <asp:DropDownList ID="ddlLote" runat="server" CssClass="form-control"></asp:DropDownList>
                    </div>
                </div>
