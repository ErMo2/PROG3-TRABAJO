            ...
            <div class="card-body">
                ...
                <div class="card border">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3 row">
                            <asp:Label ID="lblNombre" runat="server" Text="Nombre del Pedido:" CssClass="col-sm-2 col-form-label" />
                            <div class="col-sm-8">
                                <asp:TextBox ID="txtNombrePedido" runat="server" CssClass="form-control"/>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <asp:GridView ID="gvDetallesPedidos" runat="server" AllowPaging="true" PageSize="5" AutoGenerateColumns="false"
                                CssClass="table table-hover table-responsive table-striped" OnRowDataBound="gvDetallePedido_RowDataBound">
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:LinkButton runat="server" Text="<i class='fa-solid fa-trash ps-2'></i>" CommandArgument='<%# Eval("id_DetallePedido") %>' OnClick="btnEliminarProducto_Click" OnClientClick="return confirm('¿Está seguro que desea eliminar?');"/>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
                    ...
                    <ContentTemplate>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="container row">
                                <asp:GridView ID="gvProductos" runat="server" AllowPaging="true" PageSize="5" AutoGenerateColumns="false" OnPageIndexChanging="gvProductos_PageIndexChanging"
