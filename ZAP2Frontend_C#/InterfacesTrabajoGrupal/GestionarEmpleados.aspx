<%@ Page Title="" Language="C#" MasterPageFile="~/SoftProg.Master" AutoEventWireup="true" CodeBehind="GestionarEmpleados.aspx.cs" Inherits="InterfacesTrabajoGrupal.GestionarEmpleados1" %>
    ...
    <div class="card">
     ...
     <div class="col-sm-8">
         <input class="form-control" type="date" id="dtpFechaNacimiento" runat="server">
            ...
            <hr />
        <h2>Seleccione el tipo de empleado:</h2>
            <hr />

        </div>
        <asp:Button ID="Button1" runat="server" Text="Gerente" 
         CssClass="float-start btn btn-secondary" OnClick="btnGerente_Click"/>
        <hr />
        <asp:Button ID="Button2" runat="server" Text="Empleado de Area" 
    CssClass="float-start btn btn-secondary" OnClick="btnEmpleadoDeArea_Click"/>
        <hr />
        <asp:Button ID="Button3" runat="server" Text="Cajero" 
    CssClass="float-start btn btn-secondary" OnClick="btnCajero_Click"/>
    </div>
            <hr />
